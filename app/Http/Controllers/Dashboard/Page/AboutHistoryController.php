...
use App\Http\Requests\Dashboard\AboutHistory\ActionsRequest;
...
{
    protected $dirView = 'admin.pages.CMS.about-history.index';
    ...
    {
        $item = $this->model->getSingleData($this->module, 'SEJARAH_SINGKAT');
