            ...
            <div class="card-body">
                ...
                <form action="{{ route('member.riwayat-pekerjaan.update', $item['id']) }}" method="POST"
                    ...
                    <div class="col-md-6" style="margin-bottom: 2rem">
                        ...
                        <input type="text" class="form-control" name="jabatan" value="{{ $item['jabatan'] }}" maxlength="40">
                    ...
                    <div class="col-sm-12" style="margin-bottom: 2rem">
                        ...
                        <textarea id="editor-deskripsi" name="deskripsi">{!! $item['deskripsi'] ?? 'Tidak ada deskripsi' !!}</textarea>
...
<script>
    $(document).ready(function() {
        ...
        form.on('submit', function(e) {
            ...
            $.ajax({
                type: 'POST',
                url: "{{ route('member.riwayat-pekerjaan.update', $item->id) }}",
                dataType: 'json',
                data: formData,
                contentType: false,
                processData: false,
