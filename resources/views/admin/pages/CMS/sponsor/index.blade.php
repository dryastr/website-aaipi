            ...
            <div class="widget widget-table-one">
                <div class="widget-heading">
                    ...
                    <div class="task-action">
                        <a href="{{route('cms.sponsor.create')}}" class="btn btn-primary"><i class="fas fa-plus"></i> Tambah</a>
                    </div>
                </div>
                    ...
                    columns: [
                        ...
                        {data: 'link'},
                        {
                            ...
                            render: function(data, type, row, meta){
                                ...
                                var linkEdit = "{{route('cms.sponsor.edit', ':id')}}".replace(':id', data.id);
                                var linkDelete = "{{route('cms.sponsor.delete', ':id')}}".replace(':id', data.id);
                                var html = `
                                        <div class="d-inline-flex">
                                            ...
                                            <div class="dropdown-menu" aria-labelledby="`+idDropdown+`">
                                                <a class="dropdown-item" href="${linkEdit}">Edit</a>
                                                <button class="dropdown-item" onClick="main.confirmDelete('${linkDelete}', '#table-data')">Hapus</button>
                                            </div>
                                        </div>
                                        `;
                                return html
