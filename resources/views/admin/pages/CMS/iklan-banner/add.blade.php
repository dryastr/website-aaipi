                        ...
                        <div class="row mb-4">
                            <div class="form-group col-md-6">
                                ...
                                <div class="multiple-file-upload">
                                    <input type="file" accept="image/png, image/jpeg, image/gif" class="filepond file-upload" name="image" id="product-images" data-allow-reorder="true" data-max-file-size="3MB" data-max-files="5">
                                </div>
        ...
        <script>
            $(document).ready(function() {
                ...
                form.on('submit', function(e) {
                    ...
                    $.ajax({
                        type: 'POST',
                        url: "{{ route('cms.iklan-banner.store') }}",
                        dataType: 'json',
                        data: formData,
