                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-sm-6" id="color-input-container" style="display: none;">
                            ...
                            <div class="input-group">
                                <input type="color" class="p-0" name="color_manual" id="color_manual" placeholder="Warna Latar Belakang" style="width: 49px; height: 49px; border: none">
                                <input type="text" class="form-control" name="color" id="color" placeholder="Pilih Warna">
                            </div>
    ...
    <script src="{{asset('src/plugins/src/filepond/filepond.min.js')}}"></script>
        ...
        <script>
            const colorPicker = document.getElementById('color_manual');
