            ...
            <div class="widget widget-table-one">
                <div class="widget-heading">
                    ...
                    <div class="task-action">
                        ...
                        {{-- <a href="{{route('user-management.role.create')}}" class="btn btn-primary"><i class="fas fa-plus"></i> Tambah</a> --}}
                        @endcan
                    </div>
                </div>
                ...
                $('#table-data').DataTable({
                    ...
                    fnServerData: function ( sSource, aoData, fnCallback, oSettings ) {
                        ...
                        oSettings.jqXHR = $.ajax({
                            url: "{{route('user-management.role.view')}}",
                            data: data,
                            success: fnCallback,
                        });
                    },
                    ...
                    columns: [
                        ...
                        {data: 'description'},
                        {
                            ...
                            render: function(data, type, row, meta){
                                ...
                                var linkEdit = "{{route('user-management.role.edit', ':id')}}".replace(':id', data.id);
                                var linkDelete = "{{route('user-management.role.delete', ':id')}}".replace(':id', data.id);
                                var html = `
