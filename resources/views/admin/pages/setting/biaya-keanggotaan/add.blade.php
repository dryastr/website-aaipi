            ...
            <div class="widget widget-table-one">
                ...
                <div class="widget-content">
                    <form id="form-data" method="POST" novalidate>
                        ...
                        <div class="row mb-4">
                        <div class="form-group col-md-6">
                            <label for="jenis_keanggotaan">Tahun</label>
                            <select class="form-control" name="tahun" required>
                                <option value="">Pilih</option>
                                @for ($tahun = 2030; $tahun >= 2015; $tahun--)
                        ...
                        <div class="row mb-4">
                        <div class="form-group col-md-6">
                            <label for="jenis_keanggotaan">jenis_keanggotaan</label>
        ...
        <script>
            $(document).ready(function(){
                ...
                form.on('submit', function(e){
                    ...
                    $.ajax({
                        type: 'POST',
                        url: "{{route('setting.biaya-keanggotaan.store')}}",
                        dataType: 'json',
                        data: formData,
                        beforeSend: function(){
