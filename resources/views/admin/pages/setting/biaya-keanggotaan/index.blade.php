            ...
            <div class="widget widget-table-one">
                <div class="widget-heading">
                    ...
                    <div class="task-action">
                        ...
                        <a href="{{route('setting.biaya-keanggotaan.create')}}" class="btn btn-primary"><i class="fas fa-plus"></i> Tambah</a>
                        @endcan
                    </div>
                </div>
                ...
                $('#table-data').DataTable({
                    ...
                    fnServerData: function ( sSource, aoData, fnCallback, oSettings ) {
                        ...
                        oSettings.jqXHR = $.ajax({
                            url: "{{route('setting.biaya-keanggotaan.view')}}",
                            data: data,
                            success: fnCallback,
                        });
                    },
                    ...
                    columns: [
                        ...
                        {data: 'tahun'},
                        {data: 'status'},
                        {data: 'jenis_keanggotaan'},
                        {
                            data: null,
                            render: function(data, type, row, meta){
                                var idDropdown = "tableDropdown-" + data.id
                                var linkEdit = "{{route('setting.biaya-keanggotaan.edit', ':id')}}".replace(':id', data.id);
                                var linkDelete = "{{route('setting.biaya-keanggotaan.delete', ':id')}}".replace(':id', data.id);
                                var html = `
