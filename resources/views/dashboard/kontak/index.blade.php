            ...
            <div class="widget widget-table-one">
                <div class="widget-heading">
                    ...
                    <div class="task-action">
                        @can('kontak.create')
                        <a href="{{route('kontak.create')}}" class="btn btn-primary"><i class="fas fa-plus"></i> Tambah</a>
                        @endcan
                    </div>
                </div>
            ...
            $(document).ready(function(){
                $('#table-data').DataTable({
                    ...
                    columns: [
                        ...
                        {data: 'title_banner'},
                        {data: 'banner_url', render: function(data, type, row, meta){
                       ...
                       
                        {
                            ...
                            render: function(data, type, row, meta){
                                ...
                                var linkEdit = "{{route('kontak.edit', ':id')}}".replace(':id', data.id);
                                var linkDelete = "{{route('kontak.delete', ':id')}}".replace(':id', data.id);
                                var html = `
                                        <div class="d-inline-flex">
                                            ...
                                            <div class="dropdown-menu" aria-labelledby="`+idDropdown+`">
                                                @can('kontak.edit')<a class="dropdown-item" href="${linkEdit}">Edit</a>@endcan
                                                @can('kontak.delete')<button class="dropdown-item" onClick="main.confirmDelete('${linkDelete}', '#table-data')">Hapus</button>@endcan
                                            </div>
                                        </div>
                                        `;
                                return html
