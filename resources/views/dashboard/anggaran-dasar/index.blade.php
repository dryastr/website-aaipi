        ...
        <div class="col-md-12 layout-spacing mt-5">
            <div class="widget widget-table-one">
                <div class="widget-heading">
                    ...
                    <div class="task-action">
                        @can('anggaran-dasar.create')
                        <a href="{{route('anggaran-dasar.create')}}" class="btn btn-primary"><i class="fas fa-plus"></i> Tambah</a>
                        @endcan
                    </div>
                </div>
            ...
            $(document).ready(function(){
                ...
                form.on('submit', function(e){
                    ...
                    $.ajax({
                        ...
                        url: "{{route('anggaran-dasar.actions')}}",
                        processData: false,
                        contentType: false,
                        data: formData,
                        beforeSend: function(){
                    ...
                    columns: [
                        ...
                        {data: 'title'},
                        {
                            ...
                            render: function(data, type, row, meta){
                                ...
                                var linkEdit = "{{route('anggaran-dasar.edit', ':id')}}".replace(':id', data.id);
                                var linkDelete = "{{route('anggaran-dasar.delete', ':id')}}".replace(':id', data.id);
                                var html = `
                                        <div class="d-inline-flex">
                                            ...
                                            <div class="dropdown-menu" aria-labelledby="`+idDropdown+`">
                                                @can('anggaran-dasar.edit')<a class="dropdown-item" href="${linkEdit}">Edit</a>@endcan
                                                @can('anggaran-dasar.delete')<button class="dropdown-item" onClick="main.confirmDelete('${linkDelete}', '#table-data')">Hapus</button>@endcan
                                            </div>
                                        </div>
                                        `;
                                return html
