            ...
            <div class="widget widget-table-one">
                <div class="widget-heading">
                    ...
                    <div class="task-action">
                        ...
                        <a href="{{route('about-history.create')}}" class="btn btn-primary"><i class="fas fa-plus"></i> Tambah</a>
                        @endcan
                    </div>
                </div>
                    ...
                    columns: [
                       ...
                       
                        {
                            ...
                            render: function(data, type, row, meta){
                                ...
                                var linkEdit = "{{route('about-history.edit', ':id')}}".replace(':id', data.id);
                                var linkDelete = "{{route('about-history.delete', ':id')}}".replace(':id', data.id);
                                var html = `
