                        ...
                        <div class="row mb-4">
                            <div class="col-sm-12">
                                ...
                                <textarea id="editor-description"
                                    name="description">{!! $item['description'] ? $item['description'] : '' !!}</textarea>
                                <div id="feedback-description" class=""></div>
                            </div>
                        </div>

                        <a href="{{route('cms.program-kerja.indexNew')}}" class="btn btn-danger">Kembali</a>
    ...
    <script src="{{asset('src/plugins/src/filepond/filepond.min.js')}}"></script>
        ...
        <script>
            $(document).ready(function () {
                var textContent = CKEDITOR.replace('editor-description', {
                ...
                form.on('submit', function (e) {
                    ...
                    formData.append('description', CKEDITOR.instances['editor-description'].getData());
